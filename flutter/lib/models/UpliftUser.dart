...
class UpliftUser extends amplify_core.Model {
  ...
  UpliftUserModelIdentifier get modelIdentifier {
      return UpliftUserModelIdentifier(
        id: id
      );
  }
  ...
  const UpliftUser._internal({required this.id, required title, description, createdAt, updatedAt}): _title = title, _description = description, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'description': _description, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<UpliftUserModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<UpliftUserModelIdentifier>();
 ...
 */
class UpliftUserModelIdentifier implements amplify_core.ModelIdentifier<UpliftUser> {
  final String id;

  /** Create an instance of UpliftUserModelIdentifier using [id] the primary key. */
  const UpliftUserModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is UpliftUserModelIdentifier &&
      id == other.id;
  }
