...
void main() {
  group('Donation Amount InputFormatter', () {
    ...
    test('appends digits to existing content', () {
      final oldValue = TextEditingValue(text: '10');
      final newValue = TextEditingValue(text: '10a2b3');
      final result = formatter.formatEditUpdate(oldValue, newValue);
      expect(result.text, '1023');
    });
  });
}
