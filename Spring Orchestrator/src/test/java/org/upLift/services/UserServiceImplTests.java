...
class UserServiceImplTest {
    ...
    void updateUserProfile_switchType_throwsBadRequestException() {
        ...
        BadRequestException ex = assertThrows(BadRequestException.class,
                () -> service.updateUserProfile(updated));
    ...
    void updateUserProfile_forRecipient_updatesFieldsAndOptionalNicknameImage() {
        ...
        upR.setFirstName("X"); upR.setLastName("Y");
        upR.setStreetAddress1("1"); upR.setStreetAddress2("2");
        upR.setCity("C"); upR.setState("S"); upR.setZipCode("Z");
        upR.setLastAboutMe("about"); upR.setLastReasonForHelp("help");
        upR.setNickname("newNick"); upR.setImageUrl("newUrl");
        User updated = new User();
        updated.setId(8);
        updated.setRecipient(true);
    ...
    void addRecipient_whenAlreadyRecipient_throwsBadRequestException() {
        ...
        assertThrows(BadRequestException.class,
                () -> service.addRecipient(13, new Recipient()));
    }
    ...
    void addRecipient_success_setsRecipientDataFromDonorNickname() {
        ...
        assertTrue(saved.getRecipientData().getImageUrl()
                .endsWith("seedNick"));
        verify(userRepository).save(u);
    }
