...
public interface DonorsApi {
	...
	ResponseEntity<Void> deleteDonor(
	...
	@RequestMapping(value = "/donors/{donorId}", produces = { "application/json", "application/xml" },
			method = RequestMethod.GET)
	ResponseEntity<Donor> getDonorById(
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Created"),
			...
			@ApiResponse(responseCode = "400", description = "Invalid input") })
	@RequestMapping(value = "/donors/tagGeneration/{donorId}", method = RequestMethod.POST)
	ResponseEntity<Void> updateDonorTags(
	...
	ResponseEntity<Void> updateDonorWithForm(
