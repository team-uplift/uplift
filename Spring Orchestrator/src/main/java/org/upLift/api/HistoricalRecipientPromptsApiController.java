...
import org.upLift.model.HistoricalRecipientPrompt;
...
public class HistoricalRecipientPromptsApiController implements HistoricalRecipientPromptsApi {
	...
	public ResponseEntity<List<HistoricalRecipientPrompt>> historicalRecipientPromptsGet(@Parameter(
			in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests.", required = true,
	...
	public ResponseEntity<HistoricalRecipientPrompt> historicalRecipientPromptsPost(
	...
	public ResponseEntity<List<HistoricalRecipientPrompt>> historicalRecipientPromptsRecipientIdGet(
