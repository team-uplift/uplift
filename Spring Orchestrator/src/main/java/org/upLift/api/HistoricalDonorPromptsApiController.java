...
public class HistoricalDonorPromptsApiController implements HistoricalDonorPromptsApi {
	...
	public ResponseEntity<List<HistoricalDonorPrompt>> historicalDonorPromptsDonorIdGet(
	...
	public ResponseEntity<List<HistoricalDonorPrompt>> historicalDonorPromptsGet(@Parameter(in = ParameterIn.HEADER,
	...
	public ResponseEntity<HistoricalDonorPrompt> historicalDonorPromptsPost(
			@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests.",
					required = true,
					schema = @Schema()) @RequestHeader(value = "session_id", required = true) String sessionId,
