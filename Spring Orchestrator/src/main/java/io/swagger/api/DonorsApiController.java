...
public class DonorsApiController implements DonorsApi {
    ...
    public ResponseEntity<Recipient> addDonor(@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests." ,required=true,schema=@Schema()) @RequestHeader(value="session_id", required=true) String sessionId
,@Parameter(in = ParameterIn.DEFAULT, description = "Create a new recipient in the store", required=true, schema=@Schema()) @Valid @RequestBody Recipient body
    ...
    public ResponseEntity<Void> deleteDonor(@Parameter(in = ParameterIn.PATH, description = "Donor id to delete", required=true, schema=@Schema()) @PathVariable("donorId") Long donorId
...
,@Parameter(in = ParameterIn.HEADER, description = "" ,schema=@Schema()) @RequestHeader(value="api_key", required=false) String apiKey
    ...
    public ResponseEntity<Donor> getDonorById(@Parameter(in = ParameterIn.PATH, description = "ID of donor to return", required=true, schema=@Schema()) @PathVariable("donorId") Long donorId
,@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests." ,required=true,schema=@Schema()) @RequestHeader(value="session_id", required=true) String sessionId
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<Recipient> updateDonor(@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests." ,required=true,schema=@Schema()) @RequestHeader(value="session_id", required=true) String sessionId
,@Parameter(in = ParameterIn.DEFAULT, description = "Update an existent donor in the store", required=true, schema=@Schema()) @Valid @RequestBody Recipient body
    ...
    public ResponseEntity<Void> updateDonorTags(@Parameter(in = ParameterIn.PATH, description = "Donor id to generate tags for", required=true, schema=@Schema()) @PathVariable("donorId") Long donorId
,@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests." ,required=true,schema=@Schema()) @RequestHeader(value="session_id", required=true) String sessionId
,@Parameter(in = ParameterIn.HEADER, description = "" ,schema=@Schema()) @RequestHeader(value="api_key", required=false) String apiKey
,@Parameter(in = ParameterIn.QUERY, description = "A combined set of text or paragraph detailing the description to be used for tag generation" ,schema=@Schema()) @Valid @RequestParam(value = "query_text", required = false) String queryText
    ...
    public ResponseEntity<Void> updateDonorWithForm(@Parameter(in = ParameterIn.PATH, description = "ID of donor that needs to be updated", required=true, schema=@Schema()) @PathVariable("donorId") Long donorId
,@Parameter(in = ParameterIn.HEADER, description = "Tracks the session for the given set of requests." ,required=true,schema=@Schema()) @RequestHeader(value="session_id", required=true) String sessionId
